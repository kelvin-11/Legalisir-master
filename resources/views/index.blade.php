...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-lg-0 order-2 order-lg-1 "
                    ...
                    <h1><b>E-LEGALISIR</b></h1>
                    <form method="post" action="/find-data">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label text-light">NISN</label>
                            <input type="text" class="form-control" name="nisn">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label text-light">NAMA IBU</label>
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="https://smkpk.ditpsmk.net/themes/frontend/assets/img/hero.png"
                        style="width: 1000px; height: 480px;" class="img-fluid animated" alt="homePage"
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content justify-content-center">
                    <div class="col-lg-6">
                        <p>
                            Layanan ini diberikan kepada para alumni SMKN 1 JENANGAN untuk memberikan kemudahan dalam
                            melegalisir ijazah. Secara esensi layanan ini belum memanfaatkan teknologi digital
                            signature, namun bentuk layanan office online.
                            Bagi alumni yang bertempat tinggal jauh dari Ponorogo akan mendapatkan layanan kirim
                            ijazah hasil legalisir. Prosedur permintaan legalisir akan dilayani secara online</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.4176028110783!2d111.49960551415514!3d-7.851287480203326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e79a1b79ef66259%3A0xd6477895faba646d!2sSMKN%201%20Jenangan%20Ponorogo!5e0!3m2!1sid!2sid!4v1666515226658!5m2!1sid!2sid"
    ...
    <footer id="footer">
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                &copy; Copyright <strong><span><a href="https://www.instagram.com/stmjponorogo">SMKN 1
                            JENPO</a></span></strong>
            </div>
            <div class="credits">
